    ...
    React.useEffect(() => {
        async function getDataFromApi() {
          try {
            ...
            let response = await fetch('http://localhost:8000/api/placement'); // works with httphttp://api.dbine.co.uk
            // let response = await fetch('https://api.dbine.co.uk'); // does not work with https
            // let response = await fetch('https://jsonplaceholder.typicode.com/todos/1'); // other random api with https works fine
