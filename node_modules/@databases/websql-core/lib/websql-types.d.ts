export declare type OpenDatabase = (name: string, version: string, displayName: string, estimatedSize: number, creationCallback?: (database: Database) => void) => Database;
...
export interface SQLTransaction {
    executeSql(sqlStatement: string, args?: unknown[], callback?: (transaction: SQLTransaction, resultSet: SQLResultSet) => void, errorCallback?: (transaction: SQLTransaction, error: SQLError) => boolean): void;
}
